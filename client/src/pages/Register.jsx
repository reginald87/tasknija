...
import { Mail, Lock, Eye, EyeOff, User, UserPlus, Home, Building2, Tag } from 'lucide-react';
...
function Register() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true);
    const { error: err } = await signUp(email, password, fullName, role, businessName || undefined, {
      listingType: listingType || undefined,
      propertyType: propertyType || undefined,
      bedrooms: bedrooms ? parseInt(bedrooms, 10) : undefined,
      isDirectFromOwner,
